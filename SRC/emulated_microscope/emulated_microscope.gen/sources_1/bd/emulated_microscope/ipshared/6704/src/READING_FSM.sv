...
module READING_FSM#(
    ...
    output wire [ADDR_WIDTH-1:0] bram_addr_dbg,
    ...
    always @(*) begin
        ...
        tdata_out_n = 64'h00000000;  //just for debugging during simulation
        tvalid_out_n = 0;
        tlast_out_n = 0;
...
//debug signals
assign reading_fsm_state_dbg = state_r;
assign tvalid_dbg = tvalid_out_r;
assign bram_addr_dbg = bram_addr_r;
assign pixel_counter_dbg = pixel_counter_r;
