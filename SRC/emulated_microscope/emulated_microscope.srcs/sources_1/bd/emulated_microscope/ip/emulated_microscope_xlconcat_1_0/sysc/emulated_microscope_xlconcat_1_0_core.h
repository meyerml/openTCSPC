...
#ifndef _emulated_microscope_xlconcat_1_0_core_h_
#define _emulated_microscope_xlconcat_1_0_core_h_
...
class emulated_microscope_xlconcat_1_0_core : public sc_module 
{
    public: 
       emulated_microscope_xlconcat_1_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , In2    ( "In2" )
              ...
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(emulated_microscope_xlconcat_1_0_core);
    ...
    virtual ~emulated_microscope_xlconcat_1_0_core() = default;
