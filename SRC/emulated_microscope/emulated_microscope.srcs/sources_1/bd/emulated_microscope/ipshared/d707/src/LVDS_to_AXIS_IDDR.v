...
module LVDS_to_AXIS_IDDR
  ...
  LVDS_to_AXIS_IDDR_BUFR_D_0_0 BUFR_D_BY_2
       (.CLR(proc_sys_reset_0_peripheral_reset),
        .I(Net),
        .O(BUFR_D_0_O));
