...
module LVDS_to_AXIS_IDDR
  ...
  LVDS_to_AXIS_IDDR_ila_0_1 ila_LVDS_native
       (.clk(Net),
        .probe0(SDO_IBUF_OUT),
        .probe1(FRAME_IBUF_OUT));
