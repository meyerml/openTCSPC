...
module LVDS_to_AXIS_IDDR
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ILA_CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ILA_CLK, CLK_DOMAIN LVDS_to_AXIS_IDDR_ila_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input ila_clk;
  ...
  wire [0:0]frame_n;
  wire [0:0]frame_p;
  wire ila_LVDS_fast_TRIG_OUT_ACK;
  wire ila_LVDS_fast_TRIG_OUT_TRIG;
  wire ila_clk;
  wire [0:0]l_clk_in_n;
  wire [0:0]l_clk_in_p;
  wire l_clk_out_n;
  ...
  LVDS_to_AXIS_IDDR_DDR_Stream_to_AXI_St_1_0 DDR_Stream_to_AXI_St_1
       (.C(Net),
        ...
        .enable(en),
        .msglen(msglen),
        .tdata_out(DDR_Stream_to_AXI_St_1_AXIS_TDATA),
        .tready(DDR_Stream_to_AXI_St_1_AXIS_TREADY),
        .tvalid_out(DDR_Stream_to_AXI_St_1_AXIS_TVALID));
  ...
  LVDS_to_AXIS_IDDR_IDELAYE2_CLOCK_0_0 IDELAYE2_CLOCK_0
       (.CNTVALUEIN(CNTVALUEIN_CLK),
        ...
        .LD(LD),
        .clk(clk));
  LVDS_to_AXIS_IDDR_IDELAYE2_DATA_0_0 IDELAYE2_FRAME
       (.CNTVALUEIN(CNTVALUEIN_FRAME),
        ...
        .LD(LD),
        .clk(clk));
  LVDS_to_AXIS_IDDR_IDELAYE2_FRAME_0 IDELAYE2_SDO
  ...
  LVDS_to_AXIS_IDDR_ila_0_1 ila_0
       (.clk(Net),
        .probe0(DDR_Stream_to_AXI_St_1_AXIS_TREADY),
        .probe1(DDR_Stream_to_AXI_St_1_AXIS_TDATA),
        .probe2({1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1}),
        .probe3(DDR_Stream_to_AXI_St_1_AXIS_TVALID),
        .probe4(1'b0),
        .probe5(1'b0),
  ...
  LVDS_to_AXIS_IDDR_ila_0_0 ila_LVDS_fast
       (.clk(ila_clk),
        .probe0(SDO_IBUF_OUT),
        ...
        .trig_out_ack(ila_LVDS_fast_TRIG_OUT_ACK));
  ...
  LVDS_to_AXIS_IDDR_util_ds_buf_0_3 util_ds_buf_0
