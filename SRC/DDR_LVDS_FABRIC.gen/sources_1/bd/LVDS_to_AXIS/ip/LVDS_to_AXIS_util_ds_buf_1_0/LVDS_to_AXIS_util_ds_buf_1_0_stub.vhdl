...
--               LVDS_to_AXIS_util_ds_buf_1_0_ LVDS_to_AXIS_util_ds_buf_0_1_stub.vhdl
...
entity LVDS_to_AXIS_util_ds_buf_1_0 is
  ...
  attribute CHECK_LICENSE_TYPE of LVDS_to_AXIS_util_ds_buf_1_0 : entity is "LVDS_to_AXIS_util_ds_buf_0_1,util_ds_buf,{}";
  attribute core_generation_info : string;
  attribute core_generation_info of LVDS_to_AXIS_util_ds_buf_1_0 : entity is "LVDS_to_AXIS_util_ds_buf_0_1,util_ds_buf,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=util_ds_buf,x_ipVersion=2.2,x_ipCoreRevision=7,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_SIZE=1,C_BUF_TYPE=IBUFDS,C_BUFGCE_DIV=1,C_BUFG_GT_SYNC=0,C_OBUFDS_GTE5_ADV=00,C_REFCLK_ICNTL_TX=00000,C_SIM_DEVICE=VERSAL_AI_CORE_ES1}";
