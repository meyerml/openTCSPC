...
/* Peripheral Definitions for peripheral MICROSCOPE_EMULATOR_0 */
#define XPAR_MICROSCOPE_EMULATOR_0_BASEADDR 0x40040000
#define XPAR_MICROSCOPE_EMULATOR_0_HIGHADDR 0x4007FFFF
...
#define XPAR_FABRIC_HISTOGRAMMING_NEGEDGE_FRAME_INTR 62U
