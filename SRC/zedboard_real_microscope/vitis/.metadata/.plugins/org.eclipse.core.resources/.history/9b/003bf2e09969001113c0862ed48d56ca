...
#define REFCLK_FREQUENCY 10000  //in kHz
#define FRAME_WIDTH 16  //only square frames, so height is the same. laser emulator can only handle <= 64 becuase its bram is too small
...
#define LOG_2_HIST_BIN_WIDTH 5  // log 2 of histogram bin width in picoseconds. larger values lead to less precision, but more compact histograms
