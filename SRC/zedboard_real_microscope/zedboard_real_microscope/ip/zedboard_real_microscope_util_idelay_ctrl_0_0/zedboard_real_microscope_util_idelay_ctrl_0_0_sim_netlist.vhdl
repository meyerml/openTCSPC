...
entity zedboard_real_microscope_util_idelay_ctrl_0_0_util_idelay_ctrl_v1_0_4_util_idelay_ctrl is
  port (
    rdy : out STD_LOGIC;
...
architecture STRUCTURE of zedboard_real_microscope_util_idelay_ctrl_0_0_util_idelay_ctrl_v1_0_4_util_idelay_ctrl is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity zedboard_real_microscope_util_idelay_ctrl_0_0 is
  port (
    rdy : out STD_LOGIC;
    ref_clk : in STD_LOGIC;
    rst : in STD_LOGIC
  ...
  attribute X_CORE_INFO of zedboard_real_microscope_util_idelay_ctrl_0_0 : entity is "util_idelay_ctrl_v1_0_4_util_idelay_ctrl,Vivado 2024.2";
end zedboard_real_microscope_util_idelay_ctrl_0_0;

architecture STRUCTURE of zedboard_real_microscope_util_idelay_ctrl_0_0 is
  attribute SIM_DEVICE : string;
...
begin
inst: entity work.zedboard_real_microscope_util_idelay_ctrl_0_0_util_idelay_ctrl_v1_0_4_util_idelay_ctrl
     port map (
      rdy => rdy,
      ref_clk => ref_clk,
      rst => rst
