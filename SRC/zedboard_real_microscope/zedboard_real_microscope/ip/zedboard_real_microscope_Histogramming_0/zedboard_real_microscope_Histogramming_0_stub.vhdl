...
-- Date        : Fri Jun 19 12:14:09 2026
-- Host        : LAPTOP-UKM8GMC3 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub
--               c:/openTCSPC3/SRC/zedboard_real_microscope/zedboard_real_microscope/ip/zedboard_real_microscope_Histogramming_0/zedboard_real_microscope_Histogramming_0_stub.vhdl
-- Design      : zedboard_real_microscope_Histogramming_0
...
entity zedboard_real_microscope_Histogramming_0 is
  Port ( 
  ...
  attribute CHECK_LICENSE_TYPE of zedboard_real_microscope_Histogramming_0 : entity is "zedboard_real_microscope_Histogramming_0,histo,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of zedboard_real_microscope_Histogramming_0 : entity is "zedboard_real_microscope_Histogramming_0,histo,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=Histogramming,x_ipVersion=1.9,x_ipCoreRevision=2,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of zedboard_real_microscope_Histogramming_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of zedboard_real_microscope_Histogramming_0 : entity is "IPI";
end zedboard_real_microscope_Histogramming_0;

architecture stub of zedboard_real_microscope_Histogramming_0 is
  attribute syn_black_box : boolean;
  attribute black_box_pad_pin : string;
  attribute syn_black_box of stub : architecture is true;
  attribute black_box_pad_pin of stub : architecture is "AXIS_IN_tdata[63:0],AXIS_IN_tlast,AXIS_IN_tready,AXIS_IN_tvalid,BINS_TO_READ[14:0],MAX_PIXELS[31:0],M_AXIS_tdata[63:0],M_AXIS_tlast,M_AXIS_tready,M_AXIS_tvalid,REFINDEX_BITS[5:0],STOPRESULT_BITS[5:0],TRIG_IN_ack,TRIG_IN_trig,TRIG_OUT_ack,TRIG_OUT_trig,aresetn,bin_full_warning,bin_written_but_never_read_warning,buffer_almost_full,clk,disable_p[0:0],en,frame_clk,ila_clk,line_clk,log_2_BIN_WIDTH[15:0],negedge_frame,pixel_clk,premature_pixel_done_error,refres_p[0:0]";
  ...
  attribute X_INTERFACE_PARAMETER of AXIS_IN_tdata : signal is "XIL_INTERFACENAME AXIS_IN, TDATA_NUM_BYTES 8, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 100000000, PHASE 0.0, LAYERED_METADATA undef, CLK_DOMAIN zedboard_real_microscope_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, ASSOCIATED_BUSIF AXIS_IN:M_AXIS, ASSOCIATED_RESET aresetn, CLK_DOMAIN zedboard_real_microscope_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
