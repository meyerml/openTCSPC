...
//               c:/openTCSPC3/SRC/zedboard_real_microscope/zedboard_real_microscope/ip/zedboard_real_microscope_Histogramming_0/zedboard_real_microscope_Histogramming_0_stub.v
...
(* CHECK_LICENSE_TYPE = "zedboard_real_microscope_Histogramming_0,histo,{}" *) (* CORE_GENERATION_INFO = "zedboard_real_microscope_Histogramming_0,histo,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=Histogramming,x_ipVersion=1.9,x_ipCoreRevision=2,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "IPI" *) (* X_CORE_INFO = "histo,Vivado 2024.2" *) 
module zedboard_real_microscope_Histogramming_0(AXIS_IN_tdata, AXIS_IN_tlast, AXIS_IN_tready, 
  AXIS_IN_tvalid, BINS_TO_READ, MAX_PIXELS, M_AXIS_tdata, M_AXIS_tlast, M_AXIS_tready, 
  M_AXIS_tvalid, REFINDEX_BITS, STOPRESULT_BITS, TRIG_IN_ack, TRIG_IN_trig, TRIG_OUT_ack, 
  TRIG_OUT_trig, aresetn, bin_full_warning, bin_written_but_never_read_warning, 
  buffer_almost_full, clk, disable_p, en, frame_clk, ila_clk, line_clk, log_2_BIN_WIDTH, 
...
/* synthesis syn_force_seq_prim="ila_clk" */;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, ASSOCIATED_BUSIF AXIS_IN:M_AXIS, ASSOCIATED_RESET aresetn, CLK_DOMAIN zedboard_real_microscope_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0" *) input clk /* synthesis syn_isclock = 1 */;
