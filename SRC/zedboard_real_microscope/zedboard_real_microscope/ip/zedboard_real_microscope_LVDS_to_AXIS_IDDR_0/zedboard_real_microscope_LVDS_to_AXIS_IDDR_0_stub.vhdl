...
--               c:/openTCSPC3/SRC/zedboard_real_microscope/zedboard_real_microscope/ip/zedboard_real_microscope_LVDS_to_AXIS_IDDR_0/zedboard_real_microscope_LVDS_to_AXIS_IDDR_0_stub.vhdl
...
entity zedboard_real_microscope_LVDS_to_AXIS_IDDR_0 is
  Port ( 
  ...
  attribute CHECK_LICENSE_TYPE of zedboard_real_microscope_LVDS_to_AXIS_IDDR_0 : entity is "zedboard_real_microscope_LVDS_to_AXIS_IDDR_0,LVDS_to_AXIS_IDDR,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of zedboard_real_microscope_LVDS_to_AXIS_IDDR_0 : entity is "zedboard_real_microscope_LVDS_to_AXIS_IDDR_0,LVDS_to_AXIS_IDDR,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=LVDS_to_AXIS_IDDR,x_ipVersion=1.27,x_ipCoreRevision=2,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of zedboard_real_microscope_LVDS_to_AXIS_IDDR_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of zedboard_real_microscope_LVDS_to_AXIS_IDDR_0 : entity is "IPI";
end zedboard_real_microscope_LVDS_to_AXIS_IDDR_0;

architecture stub of zedboard_real_microscope_LVDS_to_AXIS_IDDR_0 is
  attribute syn_black_box : boolean;
  attribute black_box_pad_pin : string;
  attribute syn_black_box of stub : architecture is true;
  attribute black_box_pad_pin of stub : architecture is "Buffer_overflow,M_AXIS_tdata[63:0],M_AXIS_tready,M_AXIS_tvalid,TRIG_IN_ack,TRIG_IN_trig,TRIG_OUT_ack,TRIG_OUT_trig,aresetn,axis_rd_data_count[31:0],axis_wr_data_count[31:0],clk,en,frame_n[0:0],frame_p[0:0],ila_clk,l_clk_in_n[0:0],l_clk_in_p[0:0],l_clk_out_n,l_clk_out_p,lvds_clk,msglen[5:0],sdo_n[0:0],sdo_p[0:0]";
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, ASSOCIATED_BUSIF M_AXIS, CLK_DOMAIN zedboard_real_microscope_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of ila_clk : signal is "XIL_INTERFACENAME CLK.ILA_CLK, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN zedboard_real_microscope_processing_system7_0_0_FCLK_CLK3, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of l_clk_in_n : signal is "XIL_INTERFACENAME CLK.L_CLK_IN_N, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN zedboard_real_microscope_l_clk_in_n, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of l_clk_in_p : signal is "XIL_INTERFACENAME CLK.L_CLK_IN_P, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN zedboard_real_microscope_l_clk_in_p, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of lvds_clk : signal is "XIL_INTERFACENAME CLK.LVDS_CLK, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN zedboard_real_microscope_processing_system7_0_0_FCLK_CLK1, INSERT_VIP 0";
