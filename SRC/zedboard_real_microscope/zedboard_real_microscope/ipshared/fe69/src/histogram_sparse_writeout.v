...
module HISTOGRAM_ARBITER_FSM#(
    ...
    //debug signals
    output wire [2:0] main_fsm_state_dbg,
    
    output wire [4:0] reading_fsm_state_dbg,
    output wire tvalid_dbg,
    output wire [$clog2(HIST_BINS)-1:0] bram_addr_dbg,
    output wire [31:0] pixel_counter_dbg,
    
    output wire tready_dbg,
    output wire tlast_dbg,
    output wire [63:0] tdata_dbg
    ...
    .tvalid_dbg(tvalid_dbg),
    .bram_addr_dbg(bram_addr_dbg),
...
assign main_fsm_state_dbg = state_r;
assign tlast_dbg = tlast_out;
assign tready_dbg = tready_out;
assign tdata_dbg = tdata_out;
