 ...
 */
  ...
  input en;
  input frame_clk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ILA_CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ILA_CLK, CLK_DOMAIN histo_clk_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input ila_clk;
  input line_clk;
  ...
  wire [13:0]HISTOGRAM_ARBITER_FSM_0_bram_addr_dbg;
  wire [2:0]HISTOGRAM_ARBITER_FSM_0_main_fsm_state_dbg;
  wire [31:0]HISTOGRAM_ARBITER_FSM_0_pixel_counter_dbg;
  wire [4:0]HISTOGRAM_ARBITER_FSM_0_reading_fsm_state_dbg;
  wire [63:0]HISTOGRAM_ARBITER_FSM_0_tdata_dbg;
  wire HISTOGRAM_ARBITER_FSM_0_tlast_dbg;
  wire HISTOGRAM_ARBITER_FSM_0_tready_dbg;
  wire HISTOGRAM_ARBITER_FSM_0_tvalid_dbg;
  ...
  histo_HISTOGRAM_ARBITER_FSM_0_0 HISTOGRAM_ARBITER_FSM_0
       (.BINS_TO_READ(BINS_TO_READ),
        ...
        .bram_addr_dbg(HISTOGRAM_ARBITER_FSM_0_bram_addr_dbg),
        .clk(clk),
        .en(en),
        .main_fsm_state_dbg(HISTOGRAM_ARBITER_FSM_0_main_fsm_state_dbg),
        .pixel_counter_dbg(HISTOGRAM_ARBITER_FSM_0_pixel_counter_dbg),
        .pixel_done(refres_p),
        .premature_pixel_done_error(premature_pixel_done_error),
        .reading_fsm_state_dbg(HISTOGRAM_ARBITER_FSM_0_reading_fsm_state_dbg),
        .tdata_dbg(HISTOGRAM_ARBITER_FSM_0_tdata_dbg),
        .tdata_in(sorter_0_AXIS_OUT_TDATA),
        .tdata_out(HISTOGRAM_ARBITER_FSM_0_AXIS_OUT_TDATA),
        .tlast_dbg(HISTOGRAM_ARBITER_FSM_0_tlast_dbg),
        .tlast_in(sorter_0_AXIS_OUT_TLAST),
        .tlast_out(HISTOGRAM_ARBITER_FSM_0_AXIS_OUT_TLAST),
        .tready_dbg(HISTOGRAM_ARBITER_FSM_0_tready_dbg),
  ...
  histo_ila_0_0 ila_histo_int
       (.clk(ila_clk),
        ...
        .probe1(HISTOGRAM_ARBITER_FSM_0_reading_fsm_state_dbg),
        .probe10(line_clk),
        .probe11(aresetn),
        .probe12(en),
        .probe13(refres_p),
        .probe14(negedge_frame),
        ...
        .probe6(HISTOGRAM_ARBITER_FSM_0_tlast_dbg),
  ...
  histo_ila_histo_out_0 ila_sorter_out1
       (.clk(clk),
        ...
        .probe1(sorter_0_AXIS_OUT_TDATA),
        .probe2({1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1}),
        .probe3(sorter_0_AXIS_OUT_TVALID),
        .probe4(sorter_0_AXIS_OUT_TLAST),
        .probe5(1'b0),
        .probe6({1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1}),
        .probe7(1'b0),
        .probe8(1'b0),
