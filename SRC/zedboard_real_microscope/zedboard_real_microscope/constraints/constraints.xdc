...
#JA1
set_property -dict {PACKAGE_PIN Y11 IOSTANDARD LVCMOS33} [get_ports frame_clk]
#JA2
set_property -dict {PACKAGE_PIN AA11 IOSTANDARD LVCMOS33} [get_ports line_clk]
#JA3
set_property -dict {PACKAGE_PIN Y10 IOSTANDARD LVCMOS33} [get_ports pixel_clk]
...
#JA8
set_property -dict {PACKAGE_PIN AB10 IOSTANDARD LVCMOS33} [get_ports line_clk_sim]
#JA9
set_property -dict {PACKAGE_PIN AB9 IOSTANDARD LVCMOS33} [get_ports pixel_clk_sim]