...
set_false_path -from [get_pins -hierarchical -filter {NAME =~ *real_microscope_i/axi_gpio_*}]
...
set_false_path -to [get_pins -hierarchical -filter {NAME =~ *system_ila*}]

set_false_path -from [get_pins real_microscope_i/Microscope_Emulator_0/inst/laser_signal_generat_0/inst/pixel_clk_r_reg/C] -to [get_pins emulated_microscope_i/Histogramming/inst/pixel_posedge_detect/inst/old_reg/D]
set_false_path -from [get_pins real_microscope_i/Microscope_Emulator_0/inst/laser_signal_generat_0/inst/frame_clk_r_reg/C] -to [get_pins emulated_microscope_i/Histogramming/inst/frame_negedge_detect/inst/old_reg/D]
