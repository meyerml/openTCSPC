...
module DelayChain (
   ...
   // output wire [4:0] CNTVALUEOUT_6,
    ...
    wire [3:0] delayed_signals; // Intermediate delayed signals
    wire [4:0] CNTVALUEOUT_array [0:3]; // Array to hold CNTVALUEOUT for all 4 instances
    // Instantiate 4 IDELAYE2 modules
    genvar i;
    generate
    ...
    assign refclk_out_delayed = delayed_signals[3]; // Output of the last delay element
